...
### 対象読者
ちょっとだけVoiceflowをさわったことがあるかたを対象としています。

### 制約
説明は、Alexaスキルにて行うので、Googleアシスタントを作成する方は適宜読み替えていただけたらと思います。
...
*「パーソナライゼーション」『フリー百科事典　ウィキペディア日本語版』より。　最終更新: 2017年7月7日 (金) 23:09 UTC　URL: https://ja.wikipedia.org/wiki/%E3%83%91%E3%83%BC%E3%82%BD%E3%83%8A%E3%83%A9%E3%82%A4%E3%82%BC%E3%83%BC%E3%82%B7%E3%83%A7%E3%83%B3*

ユーザーが、親しみを持ってスキルを使えるように、そのユーザーを意識した作り込みを行います。  
難しく聞こえるかもしれませんが、深く考える必要はありません。  
フットワーク軽くスキル開発できるのがVoiceflowの強みですので、「ある人の専用スキルを作る」程度の認識で良いです。

## 専用スキルの開発
それでは、スキル開発をしながら簡単にパーソナライズを考えていきましょう。  

例えば「小学校の子どもが時間割を確認するスキル」を思いついたとします。
ユーザーは”小学生”になりますが、性別や学年などがわかりませんので、もっと具体的にしていきます。
このユーザーを具体的していく手段として”ペルソナ”というツールを使います。
...
*「ペルソナデザイン」『フリー百科事典　ウィキペディア日本語版』より。　最終更新: 2019年9月27日 (金) 03:51 UTC　URL: https://ja.wikipedia.org/wiki/%E3%83%9A%E3%83%AB%E3%82%BD%E3%83%8A%E3%83%87%E3%82%B6%E3%82%A4%E3%83%B3*

ユーザー像を明確にして、そこからサービスをフィットさせていきます。
あまり深く考える必要はありません。  
専門的なことを知らずにスキル開発できるのがVoiceflowの強みですので、「ある人専用のスキルを作るために、ある人がどんな人か特徴をあげる」くらいで良いです。
...
*「今さら聞けない「ペルソナ」とは。意味やマーケティング上での活用方法について」ferretより。URL: https://ferret-plus.com/8116*

１つ目は、Voiceflowのコラボレーション機能を使う場合など、複数人で開発する場合に実感できると思います。  
２つ目は、まさにパーソナライズのことで、よりユーザーに寄り添える内容となることを考えやすくなるということです。  
３つ目は、備えあれば憂いなし的なことで、準備をしておけば当初作ろうと考えていたものから大きくブレないということです。  

### ペルソナの設定
ペルソナの設定をしてみましょう。  
具体的なユーザーが決まっていれば、そのユーザーをイメージして整理します。  
何を整理すればよいのか疑問かと思いますが、まずは分かっていることを並べるだけでよいと思います。

ここでは、ペルソナを設定することで作るスキルに違いが出ることが分かるように、我が子二人のペルソナを書いてみます。
...
|翌日の準備|一人でできるが、少しまちがいが多い|一人ではできないので、これからできるようになりたい|

このことをベースにどんな時間割スキルがよいかを考えていくと、長女は、自分で次の日の時間割ができますがミスが多いので「準備ができた後に、確認をしてあげる」こと、次女は、自分で準備をすることが難しいので「一緒に準備を進めてあげる」ことが望まれそうです。

このように、たったこれだけを整理するだけで、同じ小学生を対象にしたスキルであっても、求められるものに違いがあることがわかります。
...
「Speak」ブロックと「Choice」ブロックのみで作成できます。
...
### シノニム
同義語を登録します。  
通常の会話では「YES」と「はい」などを同義語として無意識に扱っていると思います。しかし、作成したスキルは、ユーザーが発した言葉が期待したものと同義かどうかを自動判別してくれません。
