...
あまり深く考える必要はありません。  
専門的なことを知らなくてもスキル開発できるのがVoiceflowの強みですので、「ある人専用のスキルを作るために、ある人がどんな人かイメージを固める」という捉え方で良いです。@<br>{}
...
### Voiceflowでスキル作成
時間割というテーマも会話フローも同じですが、会話内容はそれぞれに特化した内容になっており、エンゲージメントが高くなっていると言えます。  
